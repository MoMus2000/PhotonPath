...
cam_position = Vector3D(5, 2.5, 10)
...
sphere = Sphere(Vector3D(-4, 0.5, 0), 1, green)
sphere2 = Sphere(sphere_center, 0.5, maroon)
sphere3 = Sphere(Vector3D(-4, 2.5, 0), 1, blue)
...
for iter_num in range(0, 200):
    ...
    for val in triangles:
        ...
        try:
            ...
            if 0 <= i1 < len(vertices) and 0 <= i2 < len(vertices) and 0 <= i3 < len(vertices):
                triangle = Triangle(
                    Vector3D(*vertices[i1]) + Vector3D(random_number, 0, random_number),
                    Vector3D(*vertices[i2]) - Vector3D(-random_number, 0, -random_number),
                    Vector3D(*vertices[i3]) - Vector3D(-random_number, 0, -random_number),
                    reflective_black
                )
    ...
    base_triangle1 = Triangle(Vector3D(-2, 0, -2), Vector3D(2, 0, -2), Vector3D(0, 4, 0), orange)  # Base
    side_triangle1 = Triangle(Vector3D(-2, 0, -2), Vector3D(0, 4, 0), Vector3D(-2, 0, 2), orange)  # Side 1
    side_triangle2 = Triangle(Vector3D(2, 0, -2), Vector3D(0, 4, 0), Vector3D(2, 0, 2), orange)   # Side 2
    side_triangle3 = Triangle(Vector3D(-2, 0, 2), Vector3D(0, 4, 0), Vector3D(2, 0, 2), orange)   # Side 3
